...
const UploadAttendanceEntryDialog: React.FC<{
  showDialog: boolean;
  closeDialog: () => void;
  id?: number;
  reloadData: any;
    ...
    >
      <Formik
        ...
        onSubmit={async (values, { setSubmitting }) => {
          ...
          ServerAPI.employeesAttendanceBulkUpload(values.file, values.company_id)
            .then((response: any) => {
              if (response?.message) {
      ...
      >
        {({
          ...
          <Form className="tabdetails">
            <p className="detailed-heading mt-3">Upload Attendence</p>
...
export default UploadAttendanceEntryDialog;
