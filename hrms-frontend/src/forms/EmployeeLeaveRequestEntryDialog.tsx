...
import { extractKeys } from "../common/Utilities";
...
const EmployeeLeaveRequestEntryDialog: React.FC<{
  showDialog: boolean;
  closeDialog: () => void;
  reloadData: any;
  id?: number;
  ...
  const [initialValue, setInitialValue] = useState<APIData.EmployeeLeaveRequest>(
    InitialData.EmployeeLeaveRequest
  );
...
export default EmployeeLeaveRequestEntryDialog;
