...
// const CompanyDetailsEntryDialog: React.FC<{
//   showDialog: boolean;
//   closeDialog: () => void;
//   reloadData: any;
//   id?: number;
...
//   //     getDataFromAPI(API.EndPoint.CURRENCY_LIST, setCurrencyOption, addProcessingRequests, reduceProcessingRequests, null, true, 'currency_id', 'currency_abbreviation', 'currencies');
//   //     setFormDataSet(true);
//   }, []);
...
//             company.company_mobile_attendance =
//               response.company_mobile_attendance ? 1 : 0;
...
//     // company_default_probation_days: Yup.number().required(ProjectStrings.ValidationRequired),
...
//     ),
//     // company_address_line2: Yup.string().required(ProjectStrings.ValidationRequired),
//     company_address_city: Yup.string().required(
//       ProjectStrings.ValidationRequired
//     ),
//     company_zip: Yup.string().required(ProjectStrings.ValidationRequired),
...
//       .notOneOf([0], ProjectStrings.ValidationSelect)
//       .required(ProjectStrings.ValidationRequired),
//     // company_currency_id: Yup.number().notOneOf([0], ProjectStrings.ValidationSelect).required(ProjectStrings.ValidationRequired),
//     // company_salary_definition_type: Yup.number().notOneOf([0], ProjectStrings.ValidationSelect).required(ProjectStrings.ValidationRequired),
...
//       )
//       .required(ProjectStrings.ValidationRequired),
//     // company_mobile_attendance: Yup.number().required(ProjectStrings.ValidationRequired),
//   });
...
//             submitValues["company_zip"] =
//               submitValues["company_zip"].toString();
//             submitValues["company_mobile_attendance"] =
//               parseInt(values.company_mobile_attendance + "") === 1
//                 ? true
//                 : false;
//             if (id != undefined && id != 0) {
...
//                   {editMode ? "Edit" : "Add New"} Company Details
//                 </p>
...
//                           }}
//                         />
//                         {/* <FormField formik={formikProps} fieldProps={{ fieldType: "textbox", label: "City Name", name: "company_address_city", placeholder: "Enter City Name", required: true }} /> */}
//                       </div>
//                       <div className="col-lg-6 col-md-6 col-xl-6 text-field-empty-custom-user">
//                         <FormField
//                           formik={formikProps}
...
//                       </div>
//                       {/* <div className="col-lg-6 col-md-6 col-xl-6 text-field-empty-custom-user">
//                                                 <FormField formik={formikProps} fieldProps={{ fieldType: "select", label: "Salary Type", name: "company_salary_definition_type", placeholder: "Select Salary Type", required: true, options: salaryOptions }} />
//                                             </div> */}
//                     </div>
//                     {/* <div className="row py-3">
//                                             <div className="col-lg-6 col-md-6 col-xl-6 text-field-empty-custom-user">
//                                                 <FormField formik={formikProps} fieldProps={{ fieldType: "select", label: "Currency", name: "company_currency_id", placeholder: "Select Currency", options: currencyOption, required: true }} />
//                                             </div>
//                                         </div> */}
//                     {/* <div className="row px-2 py-3">
//                                             <div className="col-lg-12 col-md-12 col-xl-12 text-field-empty-custom-user">
//                                                 <FormField formik={formikProps} fieldProps={{ fieldType: "radio", label: "Allow attendance from mobile app? ", name: "company_mobile_attendance", options: mobileAvailableOptions, required: true }} />
//                                             </div>
//                                         </div> */}
//                     {/* <div className="row px-2 py-3">
//                                             <div className="col-lg-12 col-md-12 col-xl-12 text-field-empty-custom-user">
...
// export default CompanyDetailsEntryDialog;
  ...
  useEffect(() => {
    if (id !== undefined && id !== 0) {
      ...
      ServerAPI.getCompanyDetail(id)
        .then((response) => {
          if (response) {
      console.log("I'm triggering the api", response)
